...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/krtc-feedstock/blob/master/LICENSE.txt)

Summary: A small utility for using Kerberos authentication with requests

Development: https://github.com/slaclab/krtc
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9298&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/krtc-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `krtc` can be installed with:

```
conda install krtc
```

It is possible to list all of the versions of `krtc` available on your platform with:
